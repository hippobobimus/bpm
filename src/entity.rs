...
pub fn sprite_animation_frames(spritesheet: usize, top_left_frame: Rect, direction: Direction) -> Vec<Sprite> {
    ...
    for i in 0..3 {
        let sprite = Sprite {
                        ...
                        region: Rect::new(
                            ...
                            top_left_frame.y() + frame_height as i32 * (direction_spritesheet_row(direction) + (i % 2)),
                            frame_width,
                            frame_height,
                        ),
                        flip_horizontal: flip_frame_horizontal(direction, i),
        };
